export const dcat = `@prefix adms: <http://www.w3.org/ns/adms#> .
...
<http://www.w3.org/ns/dcat>
  a owl:Ontology ;
  adms:versionNotes "Esta es una copia del vocabulario DCAT 3 disponible en https://www.w3.org/ns/dcat.ttl"@es ;
  adms:versionNotes "This is an updated copy of the DCAT 3 vocabulary, taken from https://www.w3.org/ns/dcat.ttl"@en ;
  adms:versionNotes "Dette er en opdateret kopi af DCAT 3 som er tilgænglig på https://www.w3.org/ns/dcat.ttl"@da ;
  adms:versionNotes "Questa è una copia aggiornata del vocabolario DCAT 3 disponibile in https://www.w3.org/ns/dcat.ttl"@it ;
  adms:versionNotes "Toto je aktualizovaná kopie slovníku DCAT 3, převzatá z https://www.w3.org/ns/dcat.ttl"@cs ;
  bibo:editor [
      a foaf:Person ;
  ...
  dcat:hasVersion <http://www.w3.org/ns/dcat2> ;
  dcat:hasVersion <http://www.w3.org/ns/dcat3> ;
...
#  dcterms:issued ""^^xsd:date ;
  ...
  dcterms:modified "2021-09-27"^^xsd:date ;
  ...
  dcterms:title "El vocabulario de catálogo de datos"@es ;
  dcterms:title "Il vocabolario del catalogo dei dati"@it ;
  dcterms:title "Le vocabulaire des catalogues de données"@fr ;
  dcterms:title "Slovník pro datové katalogy"@cs ;
  dcterms:title "The data catalog vocabulary"@en ;
  dcterms:title "Το λεξιλόγιο των καταλόγων δεδομένων"@el ;
  dcterms:title "أنطولوجية فهارس قوائم البيانات"@ar ;
  dcterms:title "データ・カタログ語彙（DCAT）"@ja ;
  dcterms:title "Datakatalogvokabular"@da ;
  foaf:depiction <https://www.w3.org/TR/vocab-dcat-3/images/dcat-all-attributes.svg> ;
  owl:backwardCompatibleWith <http://www.w3.org/ns/dcat2> ;
  owl:backwardCompatibleWith <http://www.w3.org/ns/dcat2014> ;
  owl:imports dcterms: ;
...
dcat:Catalog
  ...
  skos:definition "Una colección curada de metadatos sobre recursos."@es ;
  skos:definition "Una raccolta curata di metadati sulle risorse."@it ;
  ...
  skos:definition "En samling af metadata om ressourcer."@da ;
  skos:editorialNote "Multilingual text not completelly updated. Translations for skos:scopeNote and definitions to doublecheck."@en ;
...
dcat:DataService
  ...
  skos:changeNote "New class added in DCAT 2."@en ;
  skos:changeNote "Nová třída přidaná ve verzi DCAT 2."@cs ;
  skos:changeNote "Nueva clase añadida en DCAT 2."@es ;
  skos:changeNote "Nuova classe aggiunta in DCAT 2."@it ;
  skos:changeNote "Ny klasse tilføjet i DCAT 2."@da ;
  ...
  skos:scopeNote "Druh služby může být indikován vlastností dcterms:type. Její hodnota může být z řízeného slovníku, kterým je například slovník typů prostorových datových služeb INSPIRE."@cs ;
  skos:scopeNote "El tipo de servicio puede indicarse usando la propiedad dcterms:type. Su valor puede provenir de un vocabulario controlado, como por ejemplo el vocabulario de servicios de datos espaciales de INSPIRE."@es ;
  ...
  skos:scopeNote "Il tipo di servizio può essere indicato usando la proprietà dcterms:type. Il suo valore può essere preso da un vocabolario controllato come il vocabolario dei tipi di servizi per dati spaziali di INSPIRE."@it ;
  ...
  skos:scopeNote "The kind of service can be indicated using the dcterms:type property. Its value may be taken from a controlled vocabulary such as the INSPIRE spatial data service type vocabulary."@en ;
  skos:scopeNote "Datatjenestetypen kan indikeres ved hjælp af egenskaben dcterms:type. Værdien kan tages fra kontrollerede udfaldsrum såsom INSPIRE spatial data service vocabulary."@da ;
...
dcat:DatasetSeries
  ...
  rdfs:comment "Una collezione di dataset che sono pubblicati separatamente, ma che condividono caratteristiche che li rendono parte di uno stesso gruppo."@it ;
  rdfs:comment "Una colección de conjuntos de datos publicados por separado, pero que comparten características que los agrupan."@es ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "Dataset series"@en ;
  rdfs:label "Serie de conjuntos de datos"@es ;
  rdfs:label "Serie di dataset"@it ;
  rdfs:subClassOf dcat:Dataset ;
  skos:editorialNote "2022-05-08 Added to ttl file with annotations in English, Spanish and Italian, except notes that are in other languages too."@en ;
  skos:changeNote "New class added in DCAT 3."@en ;
  skos:changeNote "Nueva clase agregada en DCAT 3."@es ;
  skos:changeNote "Nová třída přidaná ve verzi DCAT 3"@cs ;
  skos:changeNote "Nuova classe aggiunta in DCAT 3"@it ;
  skos:changeNote "Ny klasse tilføjet i DCAT 3"@da ;
  ...
  skos:definition "Una collezione di dataset che sono pubblicati separatamente, ma che condividono caratteristiche che li rendono parte di uno stesso gruppo."@it ;
  skos:definition "Una colección de conjuntos de datos publicados por separado, pero que comparten características comunes que los agrupan."@es ;
  skos:scopeNote "Common scenarios for dataset series include: time series composed of periodically released subsets; map-series composed of items of the same type or theme but with differing spatial footprints."@en ;
  skos:scopeNote "Algunos escenarios comunes para series de conjuntos de datos son: series temporales compuestas de subconjuntos de datos publicados periódicamente; series de mapas compuestos de elementos del mismo tipo o tema pero con distintas huellas espaciales."@es ;
  skos:scopeNote "Scenari tipici per l'uso di serie di dataset: serie temporali costituite di dataset pubblicati regolarmente; serie di mappe costituite da elementi dello stesso tipo o tematica ma relative a differenti aree geografiche."@it ;
  skos:scopeNote "Dataset series can be also soft-typed via property dcterms:type as in the approach used in [GeoDCAT-AP], and adopted in [DCAT-AP-IT] and [GeoDCAT-AP-IT])."@en ;
  skos:scopeNote "También puede asignarse un tipo a las series de datos usando la propiedad dcterms:type como se hace en [GeoDCAT-AP], y adoptado en [DCAT-AP-IT] y [GeoDCAT-AP-IT])."@es ;
  skos:scopeNote "Le serie di dati possono anche essere denotate come tali usando la proprietà dcterms:type, secondo l'approccio usato in [GeoDCAT-AP], e adottato in [DCAT-AP-IT] e [GeoDCAT-AP-IT])."@it ;
.
dcat:Distribution
  a rdfs:Class ;
  a owl:Class ;
...
dcat:Relationship
  ...
  skos:changeNote "Nueva clase añadida en DCAT 2"@es ;
  skos:changeNote "Nuova classe aggiunta in DCAT 2"@it ;
  skos:changeNote "Ny klasse i DCAT 2"@da ;
...
dcat:Resource
  ...
  skos:editorialNote "2020-08-23 Scopenote updated  and needs to be translated"@en ;
  skos:changeNote "New class added in DCAT 2"@en ;
  skos:changeNote "Nová třída přidaná ve verzi DCAT 2"@cs ;
  skos:changeNote "Nueva clase agregada en DCAT 2"@es ;
  skos:changeNote "Nuova classe aggiunta in DCAT 2"@it ;
  skos:changeNote "Ny klasse i DCAT 2"@da ;
...
dcat:accessService
  ...
  skos:changeNote "New property added in DCAT 2."@en ;
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 2."@cs ;
  skos:changeNote "Nueva propiedad agregada en DCAT 2."@es ;
  skos:changeNote "Nuova proprietà aggiunta in DCAT 2."@it ;
  skos:changeNote "Ny egenskab tilføjet i DCAT 2."@da ;
...
dcat:bbox
  ...
  rdfs:comment "El cuadro delimitador geográfico para un recurso."@es ;
  rdfs:comment "Ohraničení geografické oblasti zdroje."@cs ;
  rdfs:comment "The geographic bounding box of a spatial thing [SDW-BP]."@en ;
  rdfs:comment "Il riquadro di delimitazione geografica di una risorsa."@it ;
  rdfs:comment "Den geografiske omskrevne firkant af en ressource."@da ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-2/> ;
  ...
  skos:changeNote "Nuova proprietà aggiunta in DCAT 2."@it ;
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 2."@cs ;
  skos:changeNote "Propiedad nueva agregada en DCAT 2."@es ;
  skos:changeNote "Ny egenskab tilføjet i DCAT 2."@da ;
...
dcat:catalog
  a rdf:Property ;
  a owl:ObjectProperty ;
  rdfs:comment "A catalog that is listed in the catalog."@en ;
  ...
  skos:editorialNote "Status: English Definition text modified by DCAT 3 revision team, translations pending."@en ;
.
dcat:centroid
  a rdf:Property ;
  a owl:DatatypeProperty ;
  rdfs:comment "El centro geográfico (centroide) de un recurso."@es ;
  rdfs:comment "Geografický střed (centroid) zdroje."@cs ;
  rdfs:comment "The geographic center (centroid) of a spatial thing [SDW-BP]."@en ;
  rdfs:comment "Il centro geografico (centroide) di una risorsa."@it ;
  rdfs:comment "Det geometrisk tyngdepunkt (centroid) for en ressource."@da ;
  rdfs:domain dcterms:Location ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-2/> ;
...
dcat:dataset
  a rdf:Property ;
  a owl:ObjectProperty ;
  rdfs:comment "A dataset that is listed in the catalog."@en ;
  ...
  skos:altLabel "datasamling"@da ;
  skos:altLabel "has dataset"@en;
  skos:definition "A dataset that is listed in the catalog."@en ;
...
dcat:distribution
  ...
  skos:altLabel "has distribution"@en ;
  rdfs:label "διανομή"@el ;
  rdfs:label "توزيع"@ar ;
...
dcat:downloadURL
  a rdf:Property ;
  a owl:ObjectProperty ;
  rdfs:comment "Ceci est un lien direct à un fichier téléchargeable en un format donnée. Exple fichier CSV ou RDF. Le format est décrit par les propriétés de distribution dcterms:format et/ou dcat:mediaType."@fr ;
  rdfs:comment "La URL de un archivo descargable en el formato dato. Por ejemplo, archivo CSV o archivo RDF. El formato se describe con las propiedades de la distribución dcterms:format y/o dcat:mediaType."@es ;
  rdfs:comment "Questo è un link diretto al file scaricabile in un dato formato. E.g. un file CSV o un file RDF. Il formato è descritto dal dcterms:format e/o dal dcat:mediaType della distribuzione."@it ;
  rdfs:comment "The URL of the downloadable file in a given format. E.g. CSV file or RDF file. The format is indicated by the distribution's dcterms:format and/or dcat:mediaType."@en ;
  rdfs:comment "URL souboru ke stažení v daném formátu, například CSV nebo RDF soubor. Formát je popsán vlastností distribuce dcterms:format a/nebo dcat:mediaType."@cs ;
  ...
  rdfs:comment "Είναι ένας σύνδεσμος άμεσης μεταφόρτωσης ενός αρχείου σε μια δεδομένη μορφή. Π.χ. ένα αρχείο CSV ή RDF. Η μορφη αρχείου περιγράφεται από τις ιδιότητες dcterms:format ή/και dcat:mediaType της διανομής."@el ;
  rdfs:comment "رابط مباشر لملف يمكن تحميله. نوع الملف يتم توصيفه باستخدام الخاصية dcterms:format dcat:mediaType "@ar ;
  rdfs:comment "URL til fil der kan downloades i et bestemt format. Fx en CSV-fil eller en RDF-fil. Formatet for distributionen angives ved hjælp af egenskaberne dcterms:format og/eller dcat:mediaType."@da ;
  rdfs:domain dcat:Distribution ;
  rdfs:isDefinedBy <http://www.w3.org/TR/vocab-dcat/> ;
  ...
  rdfs:range rdfs:Resource ;
  skos:definition "Ceci est un lien direct à un fichier téléchargeable en un format donnée. Exple fichier CSV ou RDF. Le format est décrit par les propriétés de distribution dcterms:format et/ou dcat:mediaType."@fr ;
  skos:definition "La URL de un archivo descargable en el formato dato. Por ejemplo, archivo CSV o archivo RDF. El formato se describe con las propiedades de la distribución dcterms:format y/o dcat:mediaType."@es ;
  skos:definition "Questo è un link diretto al file scaricabile in un dato formato. E.g. un file CSV o un file RDF. Il formato è descritto dal dcterms:format e/o dal dcat:mediaType della distribuzione."@it ;
  ...
  skos:definition "URL souboru ke stažení v daném formátu, například CSV nebo RDF soubor. Formát je popsán vlastností distribuce dcterms:format a/nebo dcat:mediaType."@cs ;
  ...
  skos:definition "Είναι ένας σύνδεσμος άμεσης μεταφόρτωσης ενός αρχείου σε μια δεδομένη μορφή. Π.χ. ένα αρχείο CSV ή RDF. Η μορφη αρχείου περιγράφεται από τις ιδιότητες dcterms:format ή/και dcat:mediaType της διανομής."@el ;
  skos:definition "URL til fil der kan downloades i et bestemt format. Fx en CSV-fil eller en RDF-fil. Formatet for distributionen angives ved hjælp af egenskaberne dcterms:format og/eller dcat:mediaType."@da ;
  skos:definition "رابط مباشر لملف يمكن تحميله. نوع الملف يتم توصيفه باستخدام الخاصية dcterms:format dcat:mediaType "@ar ;
...
dcat:endDate
  a rdf:Property ;
  a owl:DatatypeProperty ;
  rdfs:comment "El fin del período."@es ;
  rdfs:comment "Konec doby trvání."@cs ;
  rdfs:comment "The end of the period."@en ;
  rdfs:comment "La fine del periodo."@it ;
  rdfs:comment "Slutningen på perioden."@da ;
  ...
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 2."@cs ;
  skos:changeNote "Nueva propiedad agregada en DCAT 2."@es ;
  skos:changeNote "Ny egenskab i DCAT 2."@da ;
...
dcat:endpointDescription
  ...
  skos:changeNote "New property in DCAT 2."@en ;
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 2."@cs ;
  skos:changeNote "Nueva propiedad agregada en DCAT 2."@en ;
  skos:changeNote "Nuova proprietà in DCAT 2."@it ;
  skos:changeNote "Ny egenskab i DCAT 2."@da ;
  ...
  skos:scopeNote "La descripción del endpoint brinda detalles específicos de la instancia del endpoint, mientras que dcterms:conformsTo se usa para indicar el estándar general o especificación que implementa el endpoint."@es ;
  skos:scopeNote "La descrizione dell'endpoint fornisce dettagli specifici dell'istanza dell'endpoint reale, mentre dcterms:conformsTo viene utilizzato per indicare lo standard o le specifiche implementate dall'endpoint."@it ;
  skos:scopeNote "Popis přístupového bodu dává specifické detaily jeho konkrétní instance, zatímco dcterms:conformsTo indikuje obecný standard či specifikaci kterou přístupový bod implementuje."@cs ;
  ...
  skos:scopeNote "The endpoint description gives specific details of the actual endpoint instance, while dcterms:conformsTo is used to indicate the general standard or specification that the endpoint implements."@en ;
  ...
  skos:scopeNote "Endpointbeskrivelsen giver specifikke oplysninger om den konkrete endpointinstans, mens dcterms:conformsTo anvendes til at indikere den overordnede standard eller specifikation som endpointet er i overensstemmelse med."@da ;
.
dcat:endpointURL
  a rdf:Property ;
  a owl:ObjectProperty ;
...
dcat:first
  ...
  rdfs:comment "La prima risorsa in una collezione ordinata o in una serie di risorse, di cui la risorsa fa parte."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "first"@en ;
  ...
  skos:changeNote "Ny egenskab tilføjet i DCAT 3."@da ;
  ...
  skos:definition "La prima risorsa in una collezione ordinata o in una serie di risorse, di cui la risorsa fa parte."@it ;
  ...
  skos:scopeNote "In DCAT questa proprietà è usata per risorse che fanno parte di una dcat:DatasetSeries."@it ;
.
dcat:hasCurrentVersion
  a rdf:Property ;
  a owl:ObjectProperty ;
  owl:equivalentProperty pav:hasCurrentVersion ;
  rdfs:subPropertyOf pav:hasVersion ;
  rdfs:comment "This resource has a more specific, versioned resource with equivalent content [PAV]."@en ;
  rdfs:comment "Este recurso es más específico y versionado con contenido equivalente [PAV]."@es ;
  rdfs:comment "Per questa risorsa esiste una risorsa più specifica e versionata, ma con lo stesso contenuto."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "has current version"@en ;
  rdfs:label "tiene versión actual"@es ;
  rdfs:label "ha versione attuale"@it ;
  skos:changeNote "New property added in DCAT 3."@en ;
  skos:changeNote "Nueva propiedad agregada in DCAT 3."@es ;
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 3."@cs ;
  skos:changeNote "Nuova proprietà aggiunta in DCAT 3."@it ;
  skos:changeNote "Ny egenskab tilføjet i DCAT 3."@da ;
  skos:definition "This resource has a more specific, versioned resource with equivalent content [PAV]."@en ;
  skos:definition "Este recurso es más específico y versionado con contenido equivalente [PAV]."@es ;
  skos:definition "Per questa risorsa esiste una risorsa più specifica e versionata, ma con lo stesso contenuto."@it ;
  skos:scopeNote "This property is intended for relating a non-versioned or abstract resource to a single snapshot that can be used as a permalink to indicate the current version of the content [PAV]."@en ;
  skos:scopeNote "Esta propepiedad está destinada a relacionar un recurso no versionado o abstracto con una versión instantánea que puede usarse como un enlace permanente a la versión actual del recurso [PAV]."@es ;
  skos:scopeNote "Questa proprietà è usata per correlare una risorsa non versionata o astratta a un suo specifico snapshot che può essere usato come permalink per indicare la versione attuale del suo contenuto."@it ;
  skos:scopeNote "The notion of version used by this property is limited to versions resulting from revisions occurring to a resource as part of its life-cycle."@en ;
  skos:scopeNote "La noción de versión que se usa en esta propiedad está limitada a las versiones que resultan de revisiones de un recurso como parte de su ciclo de vida."@es ;
  skos:scopeNote "La nozione di versione usata da questa proprietà è limitata a versioni risultanti da revisioni a cui una risorsa è soggetta nel suo ciclo di vita."@it ;
.
dcat:hasVersion
  a rdf:Property ;
  a owl:ObjectProperty ;
  owl:equivalentProperty pav:hasVersion ;
  rdfs:comment "This resource has a more specific, versioned resource [PAV]."@en ;
  rdfs:comment "Este recurso tiene una versión específica."@es ;
  rdfs:comment "Per questa risorsa esiste una risorsa più specifica e versionata."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "has version"@en ;
  rdfs:label "tiene versión"@es ;
  rdfs:label "ha versione"@it ;
  ...
  skos:changeNote "Nuova proprietà aggiunta in DCAT 3."@it ;
  skos:changeNote "Ny egenskab tilføjet i DCAT 3."@da ;
  skos:definition "This resource has a more specific, versioned resource [PAV]."@en ;
  skos:definition "Este recurso tiene una versión específica."@es ;
  skos:definition "Per questa risorsa esiste una risorsa più specifica e versionata."@it ;
  skos:scopeNote "This property is intended for relating a non-versioned or abstract resource to several versioned resources, e.g., snapshots [PAV]."@en ;
  skos:scopeNote "Esta propiedad se utiliza para relacionar un recurso abstracto o no versionado de un recurso con varias versiones del recuros; por ejemplo, versiones intastáneas."@es ;
  skos:scopeNote "Questa proprietà è usata per correlare una risorsa non versionata o astratta a differenti risorse versionate, ad es., i relativi snapshot."@it ;
  ...
  skos:scopeNote "La noción de versión que se usa en esta propiedad está limitada a las versiones que resultan de revisiones de un recurso como parte de su ciclo de vida. Por lo tanto, su semántica es más específica que su super-propiedad dcterns:hasVersion, la cuál hace uso de la noción más amplia de versión, incluyendo ediciones y adaptaciones."@es ;
  skos:scopeNote "La nozione di versione usata da questa proprietà è limitata a versioni risultanti da revisioni a cui una risorsa è soggetta nel suo ciclo di vita. Quindi la sua semantica è più specifica di quella della sua super-proprietà dcterms:hasVersion, che utilizza una nozione di versione più ampia, e include, ad es., edizioni e adattamenti."@it ;
.
dcat:hadRole
  a rdf:Property ;
  a owl:ObjectProperty ;
...
dcat:inSeries
  ...
  rdfs:comment "Una serie de conjuntos de datos del cuál un conjunto de datos es parte."@es ;
  rdfs:comment "Una serie di dataset di cui questo dataset fa parte."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "in series"@en ;
  rdfs:label "en serie"@es ;
  rdfs:label "in serie"@it ;
  ...
  skos:definition "Una serie de conjuntos de datos del cuál un conjunto de datos es parte."@es ;
  skos:definition "Una serie di dataset di cui questo dataset fa parte."@it ;
.
dcat:keyword
  a rdf:Property ;
  a owl:DatatypeProperty ;
...
dcat:last
  ...
  rdfs:comment "El último recurso en una colección ordenada o serie de recursos, al que el recurso pertenece."@es ;
  rdfs:comment "L'ultima risorsa in una collezione ordinata o in una serie di risorse, di cui la risorsa fa parte."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "last"@en ;
  rdfs:label "último"@es ;
  rdfs:label "ultimo"@it ;
  ...
  skos:definition "El último recurso en una colección ordenada o serie de recursos, al que el recurso pertenece."@es ;
  skos:definition "L'ultima risorsa in una collezione ordinata o in una serie di risorse, di cui la risorsa fa parte."@it ;
  skos:scopeNote "In DCAT this property is used for resources belonging to a dcat:DatasetSeries."@en ;
  skos:scopeNote "En DCAT esta propiedad se usa para recursos que pertenecen a una dcat:DatasetSeries."@es ;
  skos:scopeNote "In DCAT questa proprietà è usata per risorse che fanno parte di una dcat:DatasetSeries."@it ;
.
dcat:mediaType
  a rdf:Property ;
  a owl:ObjectProperty ;
  rdfs:comment "Cette propriété doit être utilisée quand c'est définit le type de média de la distribution en IANA, sinon dcterms:format DOIT être utilisé avec différentes valeurs."@fr ;
  rdfs:comment "Esta propiedad debe ser usada cuando está definido el tipo de media de la distribución en IANA, de otra manera dcterms:format puede ser utilizado con diferentes valores"@es ;
  ...
  rdfs:comment "Η ιδιότητα αυτή ΘΑ ΠΡΕΠΕΙ να χρησιμοποιείται όταν ο τύπος μέσου μίας διανομής είναι ορισμένος στο IANA, αλλιώς η ιδιότητα dcterms:format ΔΥΝΑΤΑΙ να χρησιμοποιηθεί με διαφορετικές τιμές."@el ;
  rdfs:comment "يجب استخدام هذه الخاصية إذا كان نوع الملف معرف ضمن IANA"@ar ;
  rdfs:comment "このプロパティーは、配信のメディア・タイプがIANAで定義されているときに使用すべきで（SHOULD）、そうでない場合には、dcterms:formatを様々な値と共に使用できます（MAY）。"@ja ;
  ...
  skos:definition "Cette propriété doit être utilisée quand c'est définit le type de média de la distribution en IANA, sinon dcterms:format DOIT être utilisé avec différentes valeurs."@fr ;
  skos:definition "Esta propiedad debe ser usada cuando está definido el tipo de media de la distribución en IANA, de otra manera dcterms:format puede ser utilizado con diferentes valores."@es ;
  ...
  skos:definition "Η ιδιότητα αυτή ΘΑ ΠΡΕΠΕΙ να χρησιμοποιείται όταν ο τύπος μέσου μίας διανομής είναι ορισμένος στο IANA, αλλιώς η ιδιότητα dcterms:format ΔΥΝΑΤΑΙ να χρησιμοποιηθεί με διαφορετικές τιμές."@el ;
  skos:definition "يجب استخدام هذه الخاصية إذا كان نوع الملف معرف ضمن IANA"@ar ;
  skos:definition "このプロパティーは、配信のメディア・タイプがIANAで定義されているときに使用すべきで（SHOULD）、そうでない場合には、dcterms:formatを様々な値と共に使用できます（MAY）。"@ja ;
  ...
  skos:scopeNote "Esta propiedad DEBERÍA usarse cuando el 'media type' de la distribución está definido en el registro IANA de 'media types' https://www.iana.org/assignments/media-types/, de lo contrario, dcterms:format PUEDE usarse con distintos valores."@es ;
  skos:scopeNote "Questa proprietà DEVE essere usata quando il tipo di media della distribuzione è definito nel registro dei tipi di media IANA https://www.iana.org/assignments/media-types/, altrimenti dcterms:format PUO 'essere usato con differenti valori."@it ;
  skos:scopeNote "Tato vlastnost BY MĚLA být použita, je-li typ média distribuce definován v registru IANA https://www.iana.org/assignments/media-types/. V ostatních případech MŮŽE být použita vlastnost dcterms:format s jinými hodnotami."@cs ;
  ...
  skos:scopeNote "Denne egenskab BØR anvendes hvis distributionens medietype optræder i 'IANA media types registry' https://www.iana.org/assignments/media-types/, ellers KAN egenskaben dcterms:format anvendes med et andet udfaldsrum."@da ;
.
...
dcat:prev
  ...
  rdfs:comment "La risorsa precedente a quella attuale in una collezione ordinata o in una serie di risorse."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "previous"@en ;
  rdfs:label "previo"@es ;
  rdfs:label "precedente"@it ;
  ...
  skos:definition "La risorsa precedente a quella attuale in una collezione ordinata o in una serie di risorse."@it ;
  skos:scopeNote "In DCAT this property is used for resources belonging to a dcat:DatasetSeries."@en ;
  skos:scopeNote "En DCAT esta propiedad se usa para recursos que pertenecen a una dcat:DatasetSeries."@es ;
  skos:scopeNote "In DCAT questa proprietà è usata per risorse che fanno parte di una dcat:DatasetSeries."@it ;
  ...
  skos:scopeNote "È importante notare che questa proprietà è diversa da dcat:previousVersion, dato che non indica una versione precedente della stessa risorsa, ma una risorsa distinta che precede immediatamente quella attuale in una collezione ordinata di risorse."@it ;
.
dcat:previousVersion
  a rdf:Property ;
  a owl:ObjectProperty ;
  owl:equivalentProperty pav:previousVersion ;
  rdfs:comment "The previous version of a resource in a lineage [PAV]."@en ;
  rdfs:comment "La versione precedente di una risorsa."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "previous version"@en ;
  rdfs:label "versión anterior"@es ;
  rdfs:label "versione precedente"@it ;
  rdfs:subPropertyOf prov:wasRevisionOf ;
  skos:definition "The previous version of a resource in a lineage [PAV]."@en ;
  skos:definition "La versione precedente di una risorsa."@it ;
  skos:scopeNote "This property is meant to be used to specify a version chain, consisting of snapshots of a resource."@en ;
  skos:scopeNote "Questa proprietà è usata per specificare una catena di versioni, costituita da snapshot di una risorsa."@it ;
  skos:scopeNote "The notion of version used by this property is limited to versions resulting from revisions occurring to a resource as part of its life-cycle. One of the typical cases here is representing the history of the versions of a dataset that have been released over time."@en ;
  skos:scopeNote "La nozione di versione usata da questa proprietà è limitata a versioni risultanti da revisioni a cui una risorsa è soggetta nel suo ciclo di vita. Uno dei casi tipici è la rappresentazione della storia delle versioni di un dataset, che sono state pubblicate nel corso del tempo."@it ;
  skos:changeNote "New property added in DCAT 3."@en ;
  skos:changeNote "Nueva propiedad agregada in DCAT 3."@es ;
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 3."@cs ;
  skos:changeNote "Nuova proprietà aggiunta in DCAT 3."@it ;
...
dcat:qualifiedRelation
  ...
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 2."@cs ;
  skos:changeNote "Nuova proprietà aggiunta in DCAT 2."@it ;
  skos:changeNote "Propiedad nueva añadida en DCAT 2."@es ;
  skos:changeNote "Ny egenskab tilføjet i DCAT 2."@da ;
...
dcat:resource
  ...
  skos:scopeNote "Questo è il predicate più generale per indicare l'appartenenza di una risorsa a un catalogo. Si raccomanda l'uso di una proprietà più specifica, quando disponibile."@it ;
  skos:scopeNote "See also:	Sub-properties of dcat:resource in particular dcat:dataset, dcat:catalog, dcat:service."@en ;
  skos:scopeNote "Vd. anche: Le sottoproprietà di dcat:resource, in particolare: dcat:dataset, dcat:catalog, dcat:service."@it ;
.
...
dcat:service
  a rdf:Property ;
  a owl:ObjectProperty ;
  rdfs:comment "A service that is listed in the catalog."@en ;
  ...
  skos:altLabel "has service"@en ;
  skos:changeNote "New property added in DCAT 2."@en ;
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 2."@cs ;
  skos:changeNote "Nueva propiedad añadida en DCAT 2."@es ;
  skos:changeNote "Nuova proprietà aggiunta in DCAT 2."@it ;
...
dcat:spatialResolutionInMeters
  ...
  rdfs:label "risoluzione spaziale (metri)"@it ;
  ...
  skos:changeNote "Nueva propiedad añadida en DCAT 2."@es ;
  skos:changeNote "Nuova proprietà aggiunta in DCAT 2."@it ;
  skos:changeNote "Ny genskab tilføjet i DCAT 2."@da ;
...
dcat:theme
  ...
  skos:editorialNote "Status: English Definition text  modified by DCAT revision team, all except for Italian and Czech translations are pending. Scope note has changed and its translations should be updated"@en ;
  ...
  skos:scopeNote "The set of themes used to categorize the resources are organized in a skos:ConceptScheme, skos:Collection, owl:Ontology or similar, describing all the categories and their relations in the catalog."@en ;
...
dcat:version
  a rdf:Property ;
  a owl:DatatypeProperty ;
  owl:equivalentProperty pav:version ;
  rdfs:comment "The version indicator (name or identifier) of a resource."@en ;
  rdfs:comment "El indicador de versión (nombre o identificador) del recurso."@es ;
  rdfs:comment "L'indicatore di versione (un nome o un identificatore) di una risorsa."@it ;
  rdfs:isDefinedBy <https://www.w3.org/TR/vocab-dcat-3/> ;
  rdfs:label "version"@en ;
  rdfs:label "versión"@es ;
  rdfs:label "versione"@it ;
  skos:changeNote "New property added in DCAT 3."@en ;
  skos:changeNote "Nueva propiedad agregada in DCAT 3."@es ;
  skos:changeNote "Nová vlastnost přidaná ve verzi DCAT 3."@cs ;
  skos:changeNote "Nuova proprietà aggiunta in DCAT 3."@it ;
  ...
  skos:definition "El indicador de versión (nombre o identificador) del recurso."@es ;
  skos:definition "L'indicatore di versione (un nome o un identificatore) di una risorsa"@it ;
  skos:scopeNote "DCAT does not prescribe how a version name / identifier should be specified, and refers for guidance to [DWBP]'s Best Practice 7: Provide a version indicator."@en ;
  skos:scopeNote "DCAT no prescribe cómo especificar el nombre or identificador de una versión, y como guía sugiere leer las práctica 7 en [DWBP] sobre cómo proveer un indicador de versión"@es ;
  skos:scopeNote "DCAT non prescrive come un nome o identificatore di versione dovrebbe essere specificato, e fa riferimento alle linee guida indicate in [DWBP] Best Practice 7: Provide a version indicator."@it ;
.
foaf:homepage
  a owl:ObjectProperty ;
  rdfs:comment "This axiom needed so that Protege loads DCAT 3 without errors."@en ;
  rdfs:comment "Este axioma se necesita de manera que Protege cargue DCAT3 sin problemas."@es ;
.
foaf:primaryTopic
  a owl:ObjectProperty ;
  rdfs:comment "This axiom needed so that Protege loads DCAT 3 without errors."@en;
  rdfs:comment "Este axioma se necesita de manera que Protege cargue DCAT 3 sin problemas."@es ;
.
`;
...
export const skos_xl = `@prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> .
